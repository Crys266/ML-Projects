...
accuracies = []
model = RandomForestClassifier(class_weight='balanced', n_estimators=150, max_depth=10, min_samples_split=2)
...
for fold, (train_index, test_index) in enumerate(tscv.split(sparse_matrix)):
    ...
    y_pred = (y_score > 0.4).astype(int)  # Change the decision threshold (default 0.5)
